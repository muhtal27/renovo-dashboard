...
export function ClaimSummaryCard({
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-zinc-50/70 p-5">
      ...
      <dl className="mt-5 space-y-3 border-t border-zinc-200 pt-5">
        <div className="flex items-start justify-between gap-4">
          <dt className="text-sm text-zinc-500">Deposit amount</dt>
        ...
        <div className="flex items-start justify-between gap-4">
          <dt className="text-sm text-zinc-500">Claim source</dt>
          <dd className="text-sm font-semibold text-zinc-950">
            ...
            <div key={item.id} className="border-b border-zinc-200 px-4 py-4 last:border-b-0">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-zinc-950 [overflow-wrap:anywhere]">{item.title}</p>
                  {item.decision ? (
                    <div className="mt-2">
