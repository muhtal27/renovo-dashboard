...
export function SupportingDocumentsPanel({
  ...
  return (
    <div className="border border-zinc-200/60 bg-zinc-50/70 p-5">
      <SectionHeading
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
        <label className="block">
          ...
          <input
            ...
            maxLength={80}
            className="mt-2 h-12 w-full border border-zinc-200/60 bg-white px-4 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-slate-400"
          />
        </label>
        ...
        <div>
          ...
          <button
            ...
            className="inline-flex h-12 items-center justify-center gap-2 border border-zinc-900 bg-zinc-900 px-5 text-sm font-medium text-white transition hover:bg-zinc-800 disabled:cursor-not-allowed disabled:border-zinc-200/60 disabled:bg-zinc-100 disabled:text-zinc-500"
          >
      ...
      {documents.length === 0 ? (
        ...
        <div className="mt-5 overflow-hidden border border-zinc-200/60 bg-white">
          {documents.map((document) => {
            ...
            return (
              <div
                key={document.id}
                className="flex flex-col gap-4 border-b border-zinc-200/60 px-4 py-4 last:border-b-0 lg:flex-row lg:items-start lg:justify-between"
              >
                ...
                <div className="flex flex-wrap items-center gap-2 lg:justify-end">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex h-10 items-center justify-center gap-2 border border-zinc-200/60 bg-white px-4 text-sm font-medium text-zinc-700 transition hover:bg-zinc-50"
                  >
                  ...
                  {document.canManage ? (
                    <button
                      ...
                      className="inline-flex h-10 items-center justify-center gap-2 border border-rose-200 bg-white px-4 text-sm font-medium text-rose-700 transition hover:bg-rose-50 disabled:cursor-not-allowed disabled:border-zinc-200/60 disabled:bg-zinc-100 disabled:text-zinc-500"
                    >
                      {isDeleting ? (
                        <Loader2 className="h-4 w-4 animate-spin" />
                      ) : (
