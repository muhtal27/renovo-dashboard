...
export function StepDraft({ data }: { data: OperatorCheckoutWorkspaceData }) {
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-200 bg-zinc-50/80">
                  ...
                  <th className="px-4 py-2.5 text-left text-xs font-medium text-zinc-500">Uploaded</th>
                </tr>
              </thead>
              <tbody>
