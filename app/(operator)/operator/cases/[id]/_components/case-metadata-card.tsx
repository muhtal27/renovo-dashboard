...
export function CaseMetadataCard({
  ...
  return (
    <div className="min-w-0 border-l border-slate-200 pl-0 xl:pl-5">
      <p className="text-sm font-semibold tracking-[-0.02em] text-slate-950">Case metadata</p>
      ...
      <dl className="mt-5 grid gap-x-6 gap-y-3 sm:grid-cols-2">
        ...
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 pb-3">
          <dt className="text-sm text-slate-500">Tenancy ID</dt>
          <dd className="min-w-0 text-right text-sm font-medium text-slate-950 [overflow-wrap:anywhere]">
            {workspace.tenancy.id.slice(0, 8)}
          </dd>
        </div>
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 pb-3">
          <dt className="text-sm text-slate-500">Case created</dt>
          <dd className="min-w-0 text-right text-sm font-medium text-slate-950 [overflow-wrap:anywhere]">
        ...
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 pb-3">
          ...
          <dd className="min-w-0 text-right text-sm font-medium text-slate-950">{formatDateTime(workspace.case.last_activity_at)}</dd>
        </div>
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 pb-3">
      ...
      {workspace.tenancy.notes ? (
        <div className="mt-5 border-t border-slate-200 pt-4 text-sm leading-6 text-slate-600 [overflow-wrap:anywhere]">
          {workspace.tenancy.notes}
        </div>
      ) : null}
    </div>
