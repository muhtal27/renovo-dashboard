      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
        <label className="block">
          ...
          <input
            ...
            maxLength={80}
            className="mt-2 h-12 w-full rounded-[16px] border border-slate-200 bg-white px-4 text-sm text-slate-900 placeholder:text-slate-400 focus:border-slate-400"
          />
        </label>
        ...
        <div>
          ...
          <button
            ...
            className="inline-flex h-12 items-center justify-center gap-2 rounded-[16px] border border-slate-900 bg-slate-900 px-5 text-sm font-medium text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-500"
          >
        ...
        <div className="mt-5 overflow-hidden rounded-[18px] border border-slate-200 bg-white">
          {documents.map((document) => {
            ...
            return (
              <div
                key={document.id}
                className="flex flex-col gap-4 border-b border-slate-200 px-4 py-4 last:border-b-0 lg:flex-row lg:items-start lg:justify-between"
              >
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm text-slate-500 [overflow-wrap:anywhere]">{document.name}</p>
                </div>
