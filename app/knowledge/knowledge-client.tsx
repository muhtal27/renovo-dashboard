      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <label className="relative ml-auto block w-full sm:w-[280px]">
          ...
          <input
            ...
            className="h-9 w-full rounded-lg border border-zinc-200 bg-white pl-9 pr-4 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/20 focus:outline-none"
          />
        </label>
      </div>
        ...
        {filteredRecords.length > 0 ? (
          filteredRecords.map(({ article, regionLabel }) => (
            <button
              ...
              className="block w-full rounded-xl border border-zinc-200 bg-white shadow-sm px-5 py-4 text-left transition hover:border-zinc-300 animate-fade-in-up"
            >
          ...
          <div className="rounded-xl border border-zinc-200 bg-white shadow-sm px-5 py-8 text-center text-sm text-zinc-500">
